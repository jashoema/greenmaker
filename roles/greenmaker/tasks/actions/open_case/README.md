        ...
        - open_case:
            args:
              ...
              attach_commands:
                ...
                - "show power inline"
                - "show module"
                - "show diagnostic result module {{ module_id }} detail"
                - "show post"
                - "show platform"
                - "show logging onboard slot {{ module_id }} uptime"
                - "show logging onboard slot {{ module_id }} temperature"
                - "show platform software iomd {{ module_id }}/0 oir"
                - "show hw-module subslot  {{ module_id }}/0 oir internal"
                - "show idprom module  {{ module_id }}"
